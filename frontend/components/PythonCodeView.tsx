                    ...
                    <div className="ml-auto flex items-center gap-2">
                        {activeTab === 'TERMINAL' && (
                            <button
                                ...
                                disabled={isRunning}
                                className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-xs font-bold uppercase tracking-wider transition-all ${isRunning
                            ...
                            <div className="flex-1 overflow-y-auto space-y-2 pb-4 scrollbar-thin scrollbar-thumb-slate-700" ref={scrollRef}>
                                ...
                                {logs.map((log, idx) => (
                                    <div key={idx} className="flex gap-3 animate-in fade-in slide-in-from-left-2 duration-300">
                                        ...
                                        <span className={`break-all ${log.type === 'system' ? 'text-blue-400 font-bold' :
