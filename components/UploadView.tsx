...
export const UploadView: React.FC<UploadViewProps> = ({ accounts, transactions, receipts, onProcessComplete }) => {
      ...
      if (activeMode === 'PDF') {
        ...
        await new Promise<void>((resolve, reject) => {
             reader.onload = async () => {
                ...
                try {
                    const result = await parseBankStatementPDF(base64Data, accounts, transactions);
      ...
      <div className="bg-slate-900 rounded-xl shadow-lg border border-slate-800 overflow-hidden">
        ...
        <div className="p-12 flex flex-col items-center justify-center bg-slate-900/50">
          {!isProcessing ? (
            ...
            >
              <div className={`h-16 w-16 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform ${
                activeMode === 'PDF' ? 'bg-blue-900/50 text-blue-400' : 'bg-green-900/50 text-green-400'
              }`}>
