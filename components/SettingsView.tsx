                  ...
                  <tr key={account.id} className={`transition-colors ${rowClass}`}>
                    ...
                    <td className="px-6 py-4 align-top">
                        {isEditing ? (
                           ...
                           <div className={`w-10 h-10 rounded flex items-center justify-center border shadow-sm ${
                               isParent ? 'bg-slate-700/50 border-slate-600 text-blue-400' : 'bg-slate-900 border-slate-800 text-slate-600'
                           }`}>
                               <IconComponent size={20} />
                           </div>
                        )}
